...
def get_records():
	...
	if isinstance(range_h_int,int):
		...
		from_date_utc   = arrow.get(from_date_obj, timezone).to('Asia/Taipei').strftime("%Y-%m-%d %H:%M")
		to_date_utc     = arrow.get(to_date_obj, timezone).to('Asia/Taipei').strftime("%Y-%m-%d %H:%M")
